...
public class SpringBootMybatisWithRedisApplicationTestsTest {
    @LocalServerPort
    private int port;
    @Autowired
    ...
    public void test() {
        ...
        System.out.println(testProduct.getPrice()+"newPrice"+newPrice);
        assertThat(testProduct.getPrice()).isEqualTo(newProduct.getPrice());
    }
}